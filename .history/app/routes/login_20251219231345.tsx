...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navega para página de boas-vindas com o nome do usuário
  ...
  return (
    <div className="login-container">
      ...
      <div className="login-card">
        ...
        {/* Title */}
        <h1 className="title">{isSignUp ? "Criar Conta" : "Welcome Back"}</h1>
        <p className="subtitle">
          {isSignUp ? "Já tem uma conta? " : "Don't have an account yet? "}
          <button
            type="button"
            onClick={() => {
