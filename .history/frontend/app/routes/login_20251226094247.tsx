...
export default function Login() {
  return (
    <div className="login-container">
      {/* Promo Card - Folder Style */}
      <div className="promo-card">
        <div className="promo-card-line"></div>
        <h2 className="promo-card-title">
          Get your right job and right place apply now
        </h2>
        <p className="promo-card-description">
          Be among the first founders to experience the easiest way to start run
          a business.
        </p>
        <div className="promo-card-avatars">
